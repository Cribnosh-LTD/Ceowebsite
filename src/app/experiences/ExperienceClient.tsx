                    ...
                    <div className="lg:col-span-8 order-2 lg:order-1">
                        ...
                        <div ref={timeline} className="space-y-16 md:space-y-24 relative border-l border-white/10 ml-2 md:ml-4 pl-6 md:pl-12">
                            ...
                            <div className="experience-card relative">
                                ...
                                <div className="mb-3 flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4">
                                    <h2 className="text-2xl md:text-3xl font-oswald uppercase leading-tight">Strategic Incubator: Venture Building & MBA</h2>
                            ...
                            <div className="experience-card relative">
                                <div className="absolute -left-[33px] md:-left-[57px] top-0 w-4 h-4 rounded-full bg-white/30 border-4 border-black" />
                                <div className="mb-3 flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4">
                                    <h2 className="text-2xl md:text-3xl font-oswald uppercase">Business & Technology Management</h2>
                            ...
                            <div className="experience-card relative">
                                <div className="absolute -left-[33px] md:-left-[57px] top-0 w-4 h-4 rounded-full bg-white/30 border-4 border-black" />
                                <div className="mb-3 flex flex-col md:flex-row md:items-baseline gap-1 md:gap-4">
                                    <h2 className="text-2xl md:text-3xl font-oswald uppercase">Operations, Supply Chain, and Analytics</h2>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[10px] text-gray-400 font-inter leading-relaxed hidden md:block">Leadership during COVID-19 using Agile methodologies.</p>
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[10px] text-gray-400 font-inter leading-relaxed hidden md:block">Achieved through process realignment.</p>
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[10px] text-gray-400 font-inter leading-relaxed hidden md:block">Implementation of Statistical Process Controls (SPC).</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:sticky lg:top-40">
                            ...
                            <div className="sidebar-item bg-white/5 border border-white/10 p-6 md:p-8 rounded-2xl mb-6 md:mb-8">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Leadership", "Business Analysis", "Supply Chain", "Risk Mitigation", "Agile", "Lean/Six Sigma", "Kanban", "SPC"].map((skill) => (
